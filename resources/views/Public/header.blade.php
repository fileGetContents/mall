...
<head>
    ...
    <style type="text/css">
        body {
            _behavior: url(http://127.0.0.1/v4/shop/templates/default/css/csshover.htc);
        }
    </style>
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="http://127.0.0.1/v4/shop/resource/font/font-awesome/css/font-awesome-ie7.min.css">
    <![endif]-->
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="http://127.0.0.1/v4/data/resource/js/html5shiv.js"></script>
    <script src="http://127.0.0.1/v4/data/resource/js/respond.min.js"></script>
    <![endif]-->
    <!--[if IE 6]>
    <script src="http://127.0.0.1/v4/data/resource/js/IE6_PNG.js"></script>
    <script>
...
<![endif]-->
    <script>
        var COOKIE_PRE = '8E59_';var _CHARSET = 'utf-8';var SITEURL = 'http://127.0.0.1/v4/shop';var SHOP_SITE_URL = 'http://127.0.0.1/v4/shop';var RESOURCE_SITE_URL = 'http://127.0.0.1/v4/data/resource';var RESOURCE_SITE_URL = 'http://127.0.0.1/v4/data/resource';var SHOP_TEMPLATES_URL = 'http://127.0.0.1/v4/shop/templates/default';
    </script>
...
<link href="http://127.0.0.1/v4/shop/templates/default/css/member.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/member.js"></script>
<script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/ToolTip.js"></script>
<script>
    //sidebar-menu
    ...
    $(function() {
        ...
        $('dl[nctype="checkcCommonOperations"]').find('input').click(function(){
            ...
            $.getJSON('http://127.0.0.1/v4/shop/index.php?act=member&op=common_operations', {type : _type, value : _value}, function(data){
                if (data) {
                    if (_type == 'add') {
        ...
        <ul id="sidebarMenu" class="ncm-sidebar">
            <li class="side-menu"><a href="javascript:void(0)" key="trade" >
                ...
                <ul >
                    ...
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_vr_order&op=index">虚拟兑码订单</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_favorites&op=fglist">我的收藏</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_evaluate&op=list">交易评价/晒单</a></li>
            ...
            <li class="side-menu"><a href="javascript:void(0)" key="serv" >
                ...
                <ul >
                    ...
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_consult&op=my_consult">商品咨询</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_inform&op=index">违规举报</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_mallconsult&op=index">平台客服</a></li>
                </ul>
            </li>
            <li class="side-menu"><a href="javascript:void(0)" key="info" >
                ...
                <ul >
                    <li class="selected"><a href="http://127.0.0.1/v4/shop/index.php?act=member_information&op=member">账户信息</a></li>
                    ...
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_goodsbrowse&op=list">我的足迹</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_connect&op=qqbind">第三方账号登录</a></li>
                    <li ><a href="http://127.0.0.1/v4/shop/index.php?act=member_sharemanage&op=index">分享绑定</a></li>
                </ul>
            </li>
            <li class="side-menu"><a href="javascript:void(0)" key="app" >
                ...
                <ul >
                    ...
                    <li ><a href="http://127.0.0.1/v4/cms/index.php?act=member_article&op=article_list">我的CMS</a></li>
                    <li ><a href="http://127.0.0.1/v4/circle/index.php?act=p_center&op=index">我的圈子</a></li>
                    <li ><a href="http://127.0.0.1/v4/microshop/index.php?act=home&op=index&member_id=1">我的微商城</a></li>
                </ul>
            </li>
        </ul>
    </div>
    <div class="right-layout">
        <link rel="stylesheet" type="text/css" href="http://127.0.0.1/v4/data/resource/js/jquery-ui/themes/ui-lightness/jquery.ui.css"  />

        <div class="wrap">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a  href="index.php?act=member_information&op=member">基本信息</a></li><li class="normal"><a  href="index.php?act=member_information&op=more">兴趣标签</a></li><li class="normal"><a  href="index.php?act=member_information&op=avatar">更换头像</a></li></ul>
            </div>
            <div class="ncm-user-profile">
                <div class="user-avatar"><span><img src="http://127.0.0.1/v4/data/upload/shop/common/default_user_portrait.gif"></span></div>
        ...
        <script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/common_select.js" charset="utf-8"></script>
        <script type="text/javascript">
            //注册表单验证
            $(function(){
                regionInit("region");
        ...
        <script charset="utf-8" type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/jquery-ui/i18n/zh-CN.js" ></script>  </div>
    <div class="clear"></div>
</div>
...
<script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/perfect-scrollbar.min.js"></script>
