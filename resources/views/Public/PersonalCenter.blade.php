    ...
    <div class="left-layout">
        ...
        <ul id="sidebarMenu" class="ncm-sidebar">
            ...
            <li class="side-menu"><a href="javascript:void(0)" key="info">
                ...
                <ul>
                    <li class="selected">
                        <a href="http://127.0.0.1/v4/shop/index.php?act=member_information&amp;op=member">账户信息</a></li>
    ...
    <div class="right-layout">
        ...
        <div class="wrap">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active">
                        <a href="http://127.0.0.1/v4/shop/index.php?act=member_information&amp;op=member">基本信息</a></li>
                    <li class="normal"><a href="http://127.0.0.1/v4/shop/index.php?act=member_information&amp;op=more">兴趣标签</a>
                    </li>
                    <li class="normal">
                        <a href="http://127.0.0.1/v4/shop/index.php?act=member_information&amp;op=avatar">更换头像</a></li>
                </ul>
            </div>
            <div class="ncm-user-profile">
                ...
                <div class="ncm-default-form fr">
                    <form method="post" id="profile_form" action="http://127.0.0.1/v4/shop/index.php?act=member_information&amp;op=member">
              ...
              <span class="w400">admin&nbsp;&nbsp;
                        ...
                        <dl>
                            <dt>邮箱：</dt>
                            <dd><span class="w400">&nbsp;&nbsp;
                        <a href="http://127.0.0.1/v4/shop/index.php?act=member_security&amp;op=auth&amp;type=modify_email">绑定邮箱</a>
            </span><span>
            ...
            <select name="privacy[sex]">
                ...
                <option value="2">保密</option>
                        ...
                        <dl>
                            <dt>生日：</dt>
                            <dd><span class="w400">
            <input type="text" class="text hasDatepicker" name="birthday" maxlength="10" id="birthday" value="" readonly="readonly">
            </span><span>
        ...
        <script charset="utf-8" type="text/javascript" src="/js/zh-CN.js"></script>
    </div>
    <div class="clear"></div>
</div>
...
<script>
    ...
    $(function () {
        ...
        $('dl[nctype="checkcCommonOperations"]').find('input').click(function () {
            ...
            $.getJSON('http://127.0.0.1/v4/shop/index.php?act=member&op=common_operations', {
                type: _type,
                value: _value
            }, function (data) {
                if (data) {
