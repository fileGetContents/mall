...
<head>
    ...
    <link href="http://127.0.0.1/v4/shop/templates/default/css/base.css" rel="stylesheet" type="text/css">
    <link href="http://127.0.0.1/v4/shop/templates/default/css/home_header.css" rel="stylesheet" type="text/css">
    <link href="http://127.0.0.1/v4/shop/resource/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="http://127.0.0.1/v4/shop/templates/default/css/layout.css" rel="stylesheet" type="text/css">
    <link href="http://127.0.0.1/v4/data/resource/js/perfect-scrollbar.min.css" rel="stylesheet" type="text/css">
    <link href="http://127.0.0.1/v4/data/resource/js/qtip/jquery.qtip.min.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div id="vToolbar" class="nc-appbar">
    <div class="nc-appbar-tabs" id="appBarTabs">
        <div class="user TA_delay" nctype="a-barUserInfo">
            <div class="avatar"><img src="http://127.0.0.1/v4/data/upload/shop/common/default_user_portrait.gif"/></div>
            <p>我</p>
        </div>
        <div class="user-info" nctype="barUserInfo" style="display:none;"><i class="arrow"></i>
            <div class="avatar"><img src="http://127.0.0.1/v4/data/upload/shop/common/default_user_portrait.gif"/>
                <div class="frame"></div>
            </div>
            <dl>
                <dt>Hi, admin</dt>
                <dd>当前等级：<strong nctype="barMemberGrade">V0</strong></dd>
                <dd>当前经验值：<strong nctype="barMemberExp">25</strong></dd>
            </dl>
        </div>
        <ul class="tools">
    ...
    <div class="nc-hidebar" id="ncHideBar">
        <div class="nc-hidebar-bg">
            <div class="user-avatar"><img src="http://127.0.0.1/v4/data/upload/shop/common/default_user_portrait.gif"/></div>
            <div class="frame"></div>
            <div class="show"></div>
        </div>
    </div>
...
<div class="public-top-layout w">
    <div class="topbar wrapper">
      ...
      <a href="http://127.0.0.1/v4/shop/index.php?act=member&op=home">admin</a>
            <div class="nc-grade-mini" style="cursor:pointer;" onclick="javascript:go('http://127.0.0.1/v4/shop/index.php?act=pointgrade&op=index');">V0</div>
            </span> 欢迎回来，<a href="http://127.0.0.1/v4"  title="首页" alt="首页"><span>好商城V4</span></a> <span>[<a href="http://127.0.0.1/v4/shop/index.php?act=login&op=logout">退出</a>] </span>
        </div>
        <div class="quick-menu">
            <dl class="invite"><dt><a href="http://127.0.0.1/v4/index.php?act=invite"><span>邀请返利</span></a></dt></dl>
            <dl class="down_app">
                <dt><em class="ico_tel"></em><a href="http://127.0.0.1/v4/wap">手机移动端</a><i></i></dt>
                <dd>
                    <div class="qrcode"><img src="http://127.0.0.1/v4/data/upload/shop/common/mb_app.png"></div>
                    <div class="hint">
                        <h4>扫描二维码</h4>
                        下载手机客户端</div>
                    <div class="addurl">
            ...
            <dl>
                <dt><em class="ico_shop"></em><a href="http://127.0.0.1/v4/shop/index.php?act=show_joinin&op=index" title="商家管理">商家管理</a><i></i></dt>
                <dd>
                    <ul>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=show_joinin&op=index" title="招商入驻">招商入驻</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=seller_login&op=show_login" target="_blank" title="登录商家管理中心">商家登录</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
                <dt><em class="ico_order"></em><a href="http://127.0.0.1/v4/shop/index.php?act=member_order">我的订单</a><i></i></dt>
                <dd>
                    <ul>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_order&state_type=state_new">待付款订单</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_order&state_type=state_send">待确认收货</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_order&state_type=state_noeval">待评价交易</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
                <dt><em class="ico_store"></em><a href="http://127.0.0.1/v4/shop/index.php?act=member_favorites&op=fglist">我的收藏</a><i></i></dt>
                <dd>
                    <ul>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_favorites&op=fglist">商品收藏</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_favorites&op=fslist">店铺收藏</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <ul>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=article&ac_id=2">帮助中心</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=article&ac_id=5">售后服务</a></li>
                        <li><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=article&ac_id=6">客服中心</a></li>
                    </ul>
                </dd>
            </dl>
            <dl class="weixin">
                ...
                <dd>
                    <h4>扫描二维码<br/>
                        关注商城微信号</h4>
                    <img src="http://127.0.0.1/v4/data/upload/shop/common/04781087584534013.png" > </dd>
            </dl>
        </div>
    </div>
</div>
...
<div class="wrapper" id="top-banner">
    ...
    <a href='http://www.33hao.com' target='_blank' title='好商城V3'><img style='width:1200px;height:90px' border='0' src='http://127.0.0.1/v4/data/upload/shop/adv/04891676111561966.png' alt='好商城V3'/></a></div>
<!-- 顶部广告展开效果-->
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo"><a href="http://127.0.0.1/v4"><img src="http://127.0.0.1/v4/data/upload/shop/common/logo.png" class="pngFix"></a></h1>
        <div class="site-ad">
            <a href='' title='顶部logo边广告'><img style='width:100px;height:70px' border='0' src='http://127.0.0.1/v4/data/upload/shop/adv/05048168915006375.gif' alt=''/></a>      </div>
        <div class="head-search-bar">
            ...
            <div class="keyword">热门搜索：        <ul>
                    <li><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&keyword=%E5%A5%BD%E5%95%86%E5%9F%8EV3">好商城V3</a></li>
                    <li><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&keyword=%E5%86%85%E8%A1%A3">内衣</a></li>
                    <li><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&keyword=%E7%AC%94%E8%AE%B0%E6%9C%AC">笔记本</a></li>
                    <li><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&keyword=%E6%89%8B%E6%9C%BA">手机</a></li>
                </ul>
            </div>
        ...
        <div class="head-user-menu">
            <dl class="my-mall">
                ...
                <dd>
                    <div class="sub-title">
                        <h4>admin                        <div class="nc-grade-mini" style="cursor:pointer;" onClick="javascript:go('http://127.0.0.1/v4/shop/index.php?act=pointgrade&op=index');">V0</div>

                        </h4>
                        <a href="http://127.0.0.1/v4/shop/index.php?act=member&op=home" class="arrow">我的用户中心<i></i></a></div>
                    <div class="user-centent-menu">
                        <ul>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_message&op=message">站内消息(<span>0</span>)</a></li>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_order" class="arrow">我的订单<i></i></a></li>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_consult&op=my_consult">咨询回复(<span id="member_consult">0</span>)</a></li>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_favorites&op=fglist" class="arrow">我的收藏<i></i></a></li>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_voucher">代金券(<span id="member_voucher">0</span>)</a></li>
                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=member_points" class="arrow">我的积分<i></i></a></li>
                        </ul>
                    </div>
                    <div class="browse-history">
                        ...
                        <ul>
                            <li class="no-goods"><img class="loading" src="http://127.0.0.1/v4/shop/templates/default/images/loading.gif" /></li>
                        </ul>
                    </div>
                </dd>
            </dl>
            <dl class="my-cart">
                ...
                <dd>
                    ...
                    <div class="incart-goods-box">
                        <div class="incart-goods"> <img class="loading" src="http://127.0.0.1/v4/shop/templates/default/images/loading.gif" /> </div>
                    </div>
                    <div class="checkout"> <span class="total-price">共<i>0</i>种商品</span><a href="http://127.0.0.1/v4/shop/index.php?act=cart" class="btn-cart">结算购物车中的商品</a> </div>
                </dd>
            </dl>
        </div>
    </header>
                ...
                <ul class="menu">
                    <li cat_id="256" class="odd" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=256">数码办公</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="256">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258">手机配件</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                        ...
                                        <a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=272">iPhone 配件</a>
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=259">摄影摄像</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=260">数码配件</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=261">时尚影音</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=390">电脑整机</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=391">电脑配件</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=392">外设产品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=393">网络产品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=394">办公打印</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=395">办公文仪</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1034">手机通讯</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="2" class="even" >
                        <div class="class">
                            <span class="arrow"></span>
                            <span class="ico"><img src="http://localhost/data/upload/shop/common/category-pic-2.jpg"></span>
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=2">礼品箱包</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="2">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=151">潮流女包</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=152">时尚男包</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=153">功能箱包</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=154">礼品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=155">奢侈品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="3" class="odd" >
                        <div class="class">
                            <span class="arrow"></span>
                            <span class="ico"><img src="http://localhost/data/upload/shop/common/category-pic-3.jpg"></span>
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=3">家居家装</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="3">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=200">家纺</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=201">灯具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=202">生活日用</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=203">家装软饰</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=204">清洁日用</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=205">宠物生活</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="1" class="even" >
                        <div class="class">
                            <span class="arrow"></span>
                            <span class="ico"><img src="http://localhost/data/upload/shop/common/category-pic-1.jpg"></span>
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1">服饰鞋帽</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="1">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=4">女装</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=5">男装</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=6">内衣</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=7">运动</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=8">女鞋</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=9">男鞋</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=10">配饰</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=11">童装</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="308" class="odd" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=308">家用电器</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="308">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=309">大家电</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=310">生活电器</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=311">厨房电器</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=312">个护健康</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=313">五金家装</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="470" class="even" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=470">个护化妆</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="470">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=471">面部护理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=472">身体护理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=473">口腔护理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=474">女性护理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=475">男士护理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=476">魅力彩妆</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=477">香水SPA</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="593" class="odd" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=593">食品饮料</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="593">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=594">进口食品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=595">地方特产</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=596">休闲食品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=597">粮油调味</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=598">中外名酒</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=599">饮料冲调</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=600">营养健康</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=601">亚健康调理</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=602">健康礼品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=603">生鲜食品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="888" class="even" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=888">厨房餐饮</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="888">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=889">烹饪锅具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=890">刀剪菜板</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=891">收纳保鲜</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=892">水具酒具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=893">餐具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=935">茶具/咖啡具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="530" class="odd" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=530">珠宝手表</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="530">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=531">时尚饰品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=532">纯金K金饰品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=533">金银投资</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=534">银饰</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=535">钻石饰品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=536">翡翠玉石</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=537">水晶玛瑙</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=538">宝石珍珠</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=539">婚庆</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=540">钟表手表</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="662" class="even" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=662">运动健康</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="662">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=663">户外鞋服</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=664">户外装备</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=665">运动器械</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=666">纤体瑜伽</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=667">体育娱乐</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=668">成人用品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=669">保健器械</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=670">急救卫生</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="730" class="odd" >
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=730">汽车用品</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="730">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=731">电子电器</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=732">系统养护</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=733">改装配件</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=734">汽车美容</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=735">座垫脚垫</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=736">内饰精品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=737">安全自驾</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1054">整车</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="825" class="even" style="display:none;">
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=825">玩具乐器</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="825">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=826">适用年龄</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=827">遥控/电动</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=828">毛绒布艺</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=829">娃娃玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=830">模型玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=831">健身玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=832">动漫玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=833">益智玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=834">积木拼插</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=835">DIY玩具</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=836">创意减压</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=837">乐器相关</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="959" class="odd" style="display:none;">
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=959">母婴用品</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="959">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=960">奶粉</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=961">营养辅食</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=962">尿裤湿巾</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=963">喂养用品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=964">洗护用品</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=965">童车童床</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=966">服饰寝居</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=967">妈妈专区</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                    ...
                    <li cat_id="1037" class="even" style="display:none;">
                        <div class="class">
                            ...
                            <h4><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1037">虚拟充值</a></h4>
                        </div>
                        <div class="sub-class" cat_menu_id="1037">
                            <div class="sub-class-content">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1041">充值</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1042">游戏</a></h3>
                                    </dt>
                                    <dd class="goods-class">
                                ...
                                <dl>
                                    <dt>
                                    <h3><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1043">票务</a></h3>
                                    </dt>
                                    <dd class="goods-class">
...
<div class="nch-breadcrumb-layout">
    <div class="nch-breadcrumb wrapper"><i class="icon-home"></i>
        ...
        <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=256">数码办公</a></span><span class="arrow">></span>
        <span>手机配件</span>
    </div>
</div>
<div class="nch-container wrapper" >
    <div class="left">
        <div class="nch-module nch-module-style02">
            ...
            <div class="content">
                <ul id="files" class="tree">
                    <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=256" >数码办公</a>
                        <ul>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258" class="selected">手机配件</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=264" >手机电池</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=265" >蓝牙耳机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=266" >充电器/数据线</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=267" >手机耳机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=268" >手机贴膜</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=269" >手机存储卡</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=270" >手机保护套</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=271" >车载配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=272" >iPhone 配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=273" >创意配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=274" >便携/无线音响</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=275" >手机饰品</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=259" >摄影摄像</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=276" >数码相机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=277" >单电/微单相机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=278" >单反相机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=279" >摄像机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=280" >拍立得</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=281" >镜头</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=260" >数码配件</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=282" >存储卡</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=283" >读卡器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=284" >滤镜</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=285" >闪光灯/手柄</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=286" >相机包</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=287" >三脚架/云台</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=288" >相机清洁</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=289" >相机贴膜</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=290" >机身附件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=291" >镜头附件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=292" >电池/充电器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=293" >移动电源</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=261" >时尚影音</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=294" >MP3/MP4</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=295" >智能设备</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=296" >耳机/耳麦</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=297" >音箱</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=298" >高清播放器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=299" >电子书</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=300" >电子词典</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=301" >MP3/MP4配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=302" >录音笔</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=303" >麦克风</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=304" >专业音频</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=305" >电子教育</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=306" >数码相框</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=307" >苹果配件</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=390" >电脑整机</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=398" >笔记本</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=399" >超极本</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=400" >游戏本</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=401" >平板电脑</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=402" >平板电脑配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=403" >台式机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=404" >服务器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=405" >笔记本配件</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=391" >电脑配件</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=406" >CPU</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=407" >主板</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=408" >显卡</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=409" >硬盘</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=410" >SSD固态硬盘</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=411" >内存</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=412" >机箱</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=413" >电源</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=414" >显示器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=415" >刻录机/光驱</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=416" >散热器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=417" >声卡/扩展卡</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=418" >装机配件</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=392" >外设产品</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=419" >鼠标</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=420" >键盘</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=421" >移动硬盘</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=422" >U盘</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=423" >摄像头</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=424" >外置盒</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=425" >游戏设备</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=426" >电视盒</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=427" >手写板</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=428" >鼠标垫</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=429" >插座</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=430" >UPS电源</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=431" >线缆</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=432" >电脑工具</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=433" >电脑清洁</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=393" >网络产品</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=434" >路由器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=435" >网卡</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=436" >交换机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=437" >网络存储</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=438" >3G上网</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=439" >网络盒子</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=394" >办公打印</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=440" >打印机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=441" >一体机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=442" >投影机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=443" >投影配件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=444" >传真机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=445" >复合机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=446" >碎纸机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=447" >扫描仪</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=448" >墨盒</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=449" >硒鼓</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=450" >墨粉</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=451" >色带</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=395" >办公文仪</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=452" >办公文具</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=453" >文件管理</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=454" >笔类</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=455" >纸类</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=456" >本册/便签</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=457" >学生文具</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=458" >财务用品</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=459" >计算器</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=460" >激光笔</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=461" >白板/封装</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=462" >考勤机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=463" >刻录碟片/附件</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=464" >点钞机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=465" >支付设备/POS机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=466" >安防监控</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=467" >呼叫/会议设备</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=468" >保险柜</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=469" >办公家具</a></li>
                                </ul>
                            </li>
                            <li><i class="tree-parent tree-parent-collapsed"></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1034" >手机通讯</a>
                                <ul>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1035" >手机</a></li>
                                    <li class="tree-parent tree-parent-collapsed"><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=1036" >对讲机</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
        ...
        <!-- E 推荐展位 -->
        <div class="nch-module"><a href='' title='商品列表页左侧广告位'><img style='width:206px;height:300px' border='0' src='http://127.0.0.1/v4/data/upload/shop/adv/7a4832d109ee46fe7677c1d3c30e067f.gif' alt=''/></a></div>
        <!-- 最近浏览 -->
        ...
        <div class="nch-module nch-module-style03">
            ...
            <div class="content">
                ...
                <a href="http://127.0.0.1/v4/shop/index.php?act=member_goodsbrowse&op=list" class="nch-sidebar-all-viewed">全部浏览历史</a></div>
        </div>
        ...
        <div class="shop_con_list" id="main-nav-holder">
            <nav class="sort-bar" id="main-nav">
                ...
                <div class="nch-sortbar-array"> 排序方式：
                    <ul>
                        <li class="selected"><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&order=0&key=0"  title="默认排序">默认</a></li>
                        <li ><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&key=1&order=2"  title="点击按销量从高到低排序">销量<i></i></a></li>
                        <li ><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&key=2&order=2"  title="点击按人气从高到低排序">人气<i></i></a></li>
                        <li ><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&key=3&order=2"  title="点击按价格从高到低排序">价格<i></i></a></li>
                ...
                <div class="nch-sortbar-owner"><span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&type=1" ><i></i>平台自营</a></span></div>
                <div class="nch-sortbar-owner"><span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&gift=1" ><i></i>赠品</a></span></div>
                        ...
                        <ul class="options">
                            ...
                            <div class="filter-detailc" id="addressDraw">
                                <dl class="location-hots">
                                    <dt>常用地区</dt>
                                    <dd><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=1">北京</a></dd>
                                    <dd><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=2">天津</a></dd>
                                    <dd><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=9">上海</a></dd>
                                    <dd><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=35">海外</a></dd>
                                </dl>
                                <dl class="location-all">
                                    ...
                                    <dd>
                                        <ul>
                                            <li>
                                                <p class="lt">A</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=12">安徽</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=34">澳门</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">C</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=22">重庆</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">F</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=13">福建</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">G</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=19">广东</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=28">甘肃</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=20">广西</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=24">贵州</a></span> </p>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <p class="lt">H</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=21">海南</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=3">河北</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=16">河南</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=8">黑龙江</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=17">湖北</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=18">湖南</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">J</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=10">江苏</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=14">江西</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=7">吉林</a></span> </p>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <p class="lt">N</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=6">辽宁</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=5">内蒙古</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=30">宁夏</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">Q</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=29">青海</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">S</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=15">山东</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=4">山西</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=27">陕西</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=23">四川</a></span> </p>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <p class="lt">T</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=32">台湾</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">X</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=26">西藏</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=31">新疆</a></span> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=33">香港</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">Y</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=25">云南</a></span> </p>
                                            </li>
                                            <li>
                                                <p class="lt">Z</p>
                                                <p class="lc"> <span><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=11">浙江</a></span> </p>
                                            </li>
                                        </ul>
                                    </dd>
                                </dl>
                                <p class="oreder-default"><a href="http://127.0.0.1/v4/shop/index.php?act=search&op=index&cate_id=258&area_id=0">不限地区</a></p>
                            </div>
                        </ul>
                    </div>
                </div>
            ...
            <div>
                    ...
                    <ul class="list_pic">
                        <li class="item">
                            <div class="goods-content" nctype_goods=" 233" nctype_store="1">
                                <div class="goods-pic"><a href="http://127.0.0.1/v4/shop/index.php?act=goods&op=index&goods_id=233" target="_blank" title="我在巴扎黑"><img src="http://127.0.0.1/v4/data/upload/shop/common/loading.gif" rel="lazy" data-url="http://127.0.0.1/v4/data/upload/shop/store/goods/1/1_05854006451540344_240.png" title="我在巴扎黑" alt="我在巴扎黑" /></a></div>
                                <div class="goods-info">
                                    <div class="goods-pic-scroll-show">
                                        <ul>
                                            <li class="selected"><a href="javascript:void(0);"><img src="http://127.0.0.1/v4/data/upload/shop/common/loading.gif" rel="lazy" data-url="http://127.0.0.1/v4/data/upload/shop/store/goods/1/1_05854006451540344_60.png"/></a></li>
                                        </ul>
                                    </div>
                                    <div class="goods-name"><a href="http://127.0.0.1/v4/shop/index.php?act=goods&op=index&goods_id=233" target="_blank" title="没有卖点">我在巴扎黑<em>没有卖点</em></a></div>
                                    <div class="goods-price"> <em class="sale-price" title="商城价：&yen;100.00">&yen;100.00</em> <em class="market-price" title="市场价：&yen;1000.00">&yen;1000.00</em> <span class="raty" data-score="5"></span> </div>
                                    <div class="goods-sub">
                                        <span class="goods-compare" nc_type="compare_233" data-param='{"gid":"233"}'><i></i>加入对比</span> </div>
                                    <div class="sell-stat">
                                        <ul>
                                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=goods&op=index&goods_id=233#ncGoodsRate" target="_blank" class="status">0</a>
                                                <p>商品销量</p>
                                            </li>
                                            <li><a href="http://127.0.0.1/v4/shop/index.php?act=goods&op=comments_list&goods_id=233" target="_blank">0</a>
                                                <p>用户评论</p>
                                            </li>
                                            <li><em member_id="1">&nbsp;</em></li>
                                        </ul>
                                    </div>
                                    <div class="store"><a href="http://127.0.0.1/v4/shop/index.php?act=show_store&op=index&store_id=1" title="admin" class="name">admin</a></div>
                                    <div class="add-cart">
                ...
                <form id="buynow_form" method="post" action="http://127.0.0.1/v4/shop/index.php" target="_blank">
                    <input id="act" name="act" type="hidden" value="buy" />
                    <input id="op" name="op" type="hidden" value="buy_step1" />
                    <input id="goods_id" name="cart_id[]" type="hidden"/>
                </form>
                <script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/jquery.raty/jquery.raty.min.js"></script>
                <script type="text/javascript">
                    $(document).ready(function(){
                        $('.raty').raty({
                            path: "http://127.0.0.1/v4/data/resource/js/jquery.raty/img",
                            readOnly: true,
                            width: 80,
                            score: function() {
    ...
    <div class="faq-wrapper">
        <ul>
            <li> <dl class="s1">
                    <dt>
                        帮助中心      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=10" title="查看已购买商品"> 查看已购买商品 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=7" title="如何搜索"> 如何搜索 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=40" title="积分兑换说明"> 积分兑换说明 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=9" title="我要买"> 我要买 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=6" title="如何注册成为会员"> 如何注册成为会员 </a></dd>
                </dl></li>
            <li> <dl class="s2">
                    <dt>
                        店主之家      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=11" title="如何管理店铺"> 如何管理店铺 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=13" title="如何发货"> 如何发货 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=15" title="如何申请开店"> 如何申请开店 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=12" title="查看售出商品"> 查看售出商品 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=14" title="商城商品推荐"> 商城商品推荐 </a></dd>
                </dl></li>
            <li> <dl class="s3">
                    <dt>
                        支付方式      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=29" title="邮局汇款"> 邮局汇款 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=16" title="如何注册支付宝"> 如何注册支付宝 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=28" title="分期付款"> 分期付款 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=30" title="公司转账"> 公司转账 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=17" title="在线支付"> 在线支付 </a></dd>
                </dl></li>
            <li> <dl class="s4">
                    <dt>
                        售后服务      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=33" title="返修/退换货"> 返修/退换货 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=26" title="联系卖家"> 联系卖家 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=32" title="退换货流程"> 退换货流程 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=34" title="退款申请"> 退款申请 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=31" title="退换货政策"> 退换货政策 </a></dd>
                </dl></li>
            <li> <dl class="s5">
                    <dt>
                        客服中心      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=19" title="会员修改个人资料"> 会员修改个人资料 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=21" title="修改收货地址"> 修改收货地址 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=18" title="会员修改密码"> 会员修改密码 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=20" title="商品发布"> 商品发布 </a></dd>
                </dl></li>
            <li> <dl class="s6">
                    <dt>
                        关于我们      </dt>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=24" title="招聘英才"> 招聘英才 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=23" title="联系我们"> 联系我们 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=25" title="合作及洽谈"> 合作及洽谈 </a></dd>
                    <dd><i></i><a href="http://127.0.0.1/v4/shop/index.php?act=article&op=show&article_id=22" title="关于我们"> 关于我们 </a></dd>
                </dl></li>
                    ...
                    <div class="contact-border clearfix">
                        ...
                        <div class="attention cleafix">
                            <div class="weixin f-l">
                                <img src="http://127.0.0.1/v4/data/upload/shop/common/04781087584534013.png" class="f-l jImg img-error">
                                <p class="f-l">
                                    <span>扫一扫</span>
                                    <span>关注我们</span>
                                </p>
...
<div id="footer" class="wrapper">
    ...
    Copyright 2015 <a href="http://bbs.33hao.com" target="_blank">好商城</a> All rights reserved.<br />本演示来源于<a href="http://33haocom.taobao.com" target="_blank">bbs.33hao.com</a><br/></div>
<script>
    var COOKIE_PRE = '8E59_';var _CHARSET = 'utf-8';
    var SITEURL = 'http://127.0.0.1/v4/shop';
    var SHOP_SITE_URL = 'http://127.0.0.1/v4/shop';
    var RESOURCE_SITE_URL = 'http://127.0.0.1/v4/data/resource';
    var RESOURCE_SITE_URL = 'http://127.0.0.1/v4/data/resource';
    var SHOP_TEMPLATES_URL = 'http://127.0.0.1/v4/shop/templates/default';
</script>
<script src="http://127.0.0.1/v4/data/resource/js/jquery.js"></script>
<script src="http://127.0.0.1/v4/data/resource/js/common.js" charset="utf-8"></script>
<script src="http://127.0.0.1/v4/data/resource/js/jquery-ui/jquery.ui.js"></script>
<script src="http://127.0.0.1/v4/data/resource/js/jquery.validation.min.js"></script>
<script src="http://127.0.0.1/v4/data/resource/js/jquery.masonry.js"></script>
<script src="http://127.0.0.1/v4/data/resource/js/dialog/dialog.js" id="dialog_js" charset="utf-8"></script>
<script type="text/javascript">
...
<script src="http://127.0.0.1/v4/shop/resource/js/search_goods.js"></script>
<script src="http://127.0.0.1/v4/data/resource/js/waypoints.js"></script>
<script src="http://127.0.0.1/v4/shop/resource/js/search_category_menu.js"></script>
<script type="text/javascript">
    ...
    $(function(){
        ...
        // 推荐商品异步显示
        $('div[nctype="booth_goods"]').load('http://127.0.0.1/v4/shop/index.php?act=search&op=get_booth_goods&cate_id=258', function(){
            $(this).show();
        });
        // 推荐商品异步显示
        $('div[id="gc_goods_recommend_div"]').load('http://127.0.0.1/v4/shop/index.php?act=search&op=get_hot_goods&cate_id=258', function(){
            $(this).show();
        });
        //浏览历史处滚条
        ...
        //猜你喜欢
        $('#guesslike_div').load('http://127.0.0.1/v4/shop/index.php?act=search&op=get_guesslike', function(){
            $(this).show();
        });
...
<script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/jquery.cookie.js"></script>
<script type="text/javascript">
    //返回顶部
    backTop=function (btnId){
        var btn=document.getElementById(btnId);
...
</script><script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="http://127.0.0.1/v4/data/resource/js/qtip/jquery.qtip.min.js"></script>
<script src="http://127.0.0.1/v4/shop/resource/js/compare.js"></script>
<script type="text/javascript">
    $(function(){
        // Membership card
