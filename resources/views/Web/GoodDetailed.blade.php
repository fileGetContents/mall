        ...
        <div class="dt-if1-m f-l">
            ...
            <div class="dt-ifm-gojia">
                <dl>
                    ...
                    <dd>
                        <p class="p1">
                            <span class="sp1">¥{{$good->good_preprice}}</span><span class="sp2">{{$good->good_oriprice}}</span>
                        </p>
                        <p class="p2">
    ...
    <div class="deta-info2">
        ...
        <div class="dt-if2-r f-r">
            ...
            <div style="border:1px solid #DBDBDB;" com-det-show="dt1">
                <div class="if2-tu1">
                    <img src="{{asset('')}}images/if2-tu1.gif"/>
                    <img src="{{asset('')}}images/if2-tu2.gif" style="margin-top:47px;"/>
                    <div style="clear:both;"></div>
                </div>
                <div class="if2-tu2">
                    <img src="{{asset('')}}images/if2-tu3.gif"/>
                    <div style="clear:both;"></div>
                </div>
                <div class="if2-tu3">
                    <img src="{{asset('')}}images/if2-tu4.gif"/>
                </div>
                <ul class="if2-tu4">
                    <li><img src="{{asset('')}}images/if2-tu5.gif"/></li>
                    <li><img src="{{asset('')}}images/if2-tu6.gif"/></li>
                    <li><img src="{{asset('')}}images/if2-tu7.gif"/></li>
                    <div style="clear:both;"></div>
                </ul>
            </div>
